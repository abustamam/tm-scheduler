...
| 019 | Pin `latest`/nightly dependency ranges to locked versions | P2 | S | — | [#130](https://github.com/abustamam/tm-scheduler/issues/130) | DONE — PR open (also pinned `@types/bun`, which the plan table omitted, to satisfy grep=0) |
