...
CREATE INDEX "club_action_items_club_idx" ON "club_action_items" USING btree ("club_id","created_at");--> statement-breakpoint
CREATE INDEX "club_action_items_owner_idx" ON "club_action_items" USING btree ("owner_member_id");