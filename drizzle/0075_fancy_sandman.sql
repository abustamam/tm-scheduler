...
ALTER TABLE "meeting_candidate_disqualifications" ADD CONSTRAINT "meeting_candidate_dq_meeting_fk" FOREIGN KEY ("meeting_id") REFERENCES "public"."meetings"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meeting_candidate_disqualifications" ADD CONSTRAINT "meeting_candidate_dq_member_fk" FOREIGN KEY ("candidate_member_id") REFERENCES "public"."members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meeting_candidate_disqualifications" ADD CONSTRAINT "meeting_candidate_dq_guest_fk" FOREIGN KEY ("candidate_guest_id") REFERENCES "public"."guests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "meeting_candidate_disqualifications" ADD CONSTRAINT "meeting_candidate_dq_by_member_fk" FOREIGN KEY ("disqualified_by_member_id") REFERENCES "public"."members"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "meeting_candidate_dq_meeting_idx" ON "meeting_candidate_disqualifications" USING btree ("meeting_id");--> statement-breakpoint
